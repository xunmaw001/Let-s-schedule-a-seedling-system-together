<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="预约类型" prop="yuyueleixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="预约资料" prop="yuyueziliao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yuyueziliao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuyueziliao" label="预约资料" prop="yuyueziliao">
                    <span v-html="ruleForm.yuyueziliao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renshu = true;
          ...
          if(o=='yuyueziliao'){
            this.ruleForm.yuyueziliao = obj[o];
	    this.ro.yuyueziliao = true;
            continue;
          }
          if(o=='yuyueshijian'){
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.yuyueleixingOptions = "个人,团体".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.yuyueziliao = this.ruleForm.yuyueziliao.replace(reg,'../../../springboot10h6b/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
