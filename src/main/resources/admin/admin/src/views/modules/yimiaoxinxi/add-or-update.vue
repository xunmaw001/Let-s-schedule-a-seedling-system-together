<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="疫苗种类" prop="yimiaozhonglei">
          <el-select :disabled="ro.yimiaozhonglei" v-model="ruleForm.yimiaozhonglei" placeholder="请选择疫苗种类">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接种次数" prop="jiezhongcishu">
          <el-input v-model="ruleForm.jiezhongcishu" 
              placeholder="接种次数" clearable  :readonly="ro.jiezhongcishu"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="作用" prop="zuoyong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zuoyong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyong" label="作用" prop="zuoyong">
                    <span v-html="ruleForm.zuoyong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zuoyong : false,
      ...
      rules: {
          ...
          yimiaozhonglei: [
                { required: true, message: '疫苗种类不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          shiherenqun: [
  ...
  methods: {
	...
	this.ruleForm.zuoyong = this.ruleForm.zuoyong.replace(reg,'../../../springboot10h6b/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
